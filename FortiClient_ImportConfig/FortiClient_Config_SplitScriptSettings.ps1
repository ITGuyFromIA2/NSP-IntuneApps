...
$VariableConfig.DisplayName = "FortiClient - Configure Contoso VPN"
$VariableConfig.Description = ("Downloads and configures Contoso VPN Configuration. Will Remove and re-add" -f $VariableConfig.DisplayName)
