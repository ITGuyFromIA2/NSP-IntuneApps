...
$VariableConfig.DisplayName = "Configure Manual Intune Sync Shortcut"
$VariableConfig.Description = "Modifies existing scheduled task and uses delegated Intune service to enable shortcut to perform Manual Intune Sync"
...
#Need to flesh out the other styles. I believe two others 'Registry' and 'MSI code'
    ...
    #$VariableConfig.Detection_KeyPath = "HKEY_LOCAL_MACHINE\SOFTWARE\Fortinet\FortiClient\Sslvpn\Tunnels\CONTOSO VPN"
...
$VariableConfig.AppDependency = @{
    AppName = "Delegate Intune Service to Power Users"
