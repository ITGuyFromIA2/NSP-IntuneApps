...
$VariableConfig.DisplayName = "FortiClient"
$VariableConfig.Description = ("Downloads and installs the latest version of {0} VPN-Only Edition" -f $VariableConfig.DisplayName)
