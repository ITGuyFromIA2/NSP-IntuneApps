...
#Get the current working DIR
    ...
    $MainDellCommand_IntuneAppName = "Dell Command | Update"
...
#>
# SharedDefs.ps1 is intentionally carried in this app's Source folder so catalog discovery is read-only.

#Begin App Variables
$VariableConfig = @{}

$VariableConfig.DisplayName = "Dell Command | Update - Scan for Driver Updates"
$VariableConfig.Description = "works with a scheduled task to periodically re-scan for Driver Updates"
...
$VariableConfig.RestartExperience = 'suppress'  #Can Be: 'allow' / 'basedOnReturnCode' / 'force' / 'suppress'
