...
$VariableConfig.DisplayName = "Delegate Intune Service to Power Users"
$VariableConfig.Description = "Delegates ability to start / stop Intune Service to Power Users (For manual sync use)"
