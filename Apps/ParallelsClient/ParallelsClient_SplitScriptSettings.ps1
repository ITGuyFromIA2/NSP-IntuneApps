...
$VariableConfig.DisplayName = "Parallels Client (Accubuild)"
$VariableConfig.Description = "Downloads and installs the latest version of Parallels RAS Client for use with Accubuild"
