...
$VariableConfig.DisplayName = "Parallels RAS Client (Configured Connection)"
$VariableConfig.Description = "Resolves and validates the latest official Parallels RAS Client MSI at endpoint install time, then imports an explicitly configured shared connection. Complete VM validation before deployment."
