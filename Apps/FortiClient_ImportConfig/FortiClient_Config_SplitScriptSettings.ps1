...
$VariableConfig.DisplayName = "FortiClient - Configure HnR VPN"
...
#Need to flesh out the other styles. I believe two others 'Registry' and 'MSI code'
    ...
    $VariableConfig.Detection_KeyPath = "HKEY_LOCAL_MACHINE\SOFTWARE\Fortinet\FortiClient\Sslvpn\Tunnels\HnR VPN"
