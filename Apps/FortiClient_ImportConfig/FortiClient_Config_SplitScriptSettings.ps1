...
$VariableConfig.DisplayName = "FortiClient - Configure REPLACE_WITH_VPN_NAME"
$VariableConfig.Description = "Adds or updates the configured FortiClient VPN tunnel. Generate a client-specific app from this template before deployment."
...
#Need to flesh out the other styles. I believe two others 'Registry' and 'MSI code'
    ...
    $VariableConfig.Detection_KeyPath = "HKEY_LOCAL_MACHINE\SOFTWARE\Fortinet\FortiClient\Sslvpn\Tunnels\REPLACE_WITH_VPN_NAME"
