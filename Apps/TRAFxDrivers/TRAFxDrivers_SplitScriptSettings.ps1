...
$VariableConfig.DisplayName = "TRAFx - USB to Serial Drivers"
$VariableConfig.Description = ("Downloads and installs the latest version of {0}" -f $VariableConfig.DisplayName)
