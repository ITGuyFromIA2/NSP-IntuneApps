...
$VariableConfig.DisplayName = "Google Chrome"
$VariableConfig.Description = "Downloads and installs the latest version of Google Chrome Enterprise - Straight from google's Permalink"
