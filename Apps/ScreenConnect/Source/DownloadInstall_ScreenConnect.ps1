param([string]$GuestCode = 'REPLACE_WITH_SCREENCONNECT_SESSION_GROUP')
if ($GuestCode -eq 'REPLACE_WITH_SCREENCONNECT_SESSION_GROUP') {
    throw 'Set GuestCode to the downstream client ScreenConnect session group before packaging.'
}
[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12
$FinalURL = "https://nsp.work/r/Bin/ScreenConnect.ClientSetup.msi?e=Access&y=Guest&c=$($GuestCode)&c=&c=&c=&c=&c=&c=&c="

$DestFolder = 'C:\admin\Installers'
$DestEXE = "ScreenConnect.ClientSetup.msi"
...
Invoke-WebRequest -Uri $FinalURL -OutFile $FullDest -UseBasicParsing -ErrorAction SilentlyContinue
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUtbTZWdW9SYWbIY+sl4ksb9g3
# 4qKgghY1MIIDKDCCAhCgAwIBAgIQXp50wvfoo4ZEs021q1HySzANBgkqhkiG9w0B
...
# FTAjBgkqhkiG9w0BCQQxFgQUG7tLq6Fo5rA/AzcmqFPN6ij/paMwDQYJKoZIhvcN
# AQEBBQAEggEATviRny2Ivzu6NW1hg9QSuXB4kkqgOYN2T7yqCcKifjP/BiOOL2Z4
# SWc33B3bwlRZ75HVngq5XavzTmEUSKlo3PuSI0kE+0ZofD1ij5+4Y6JwfAxNJadN
# 8eZ5N2sDis3ibjUR4eBIiG4RPbIWwk4TQl127MSQAl0650gq+ZYSwjP2WSFDGQ0X
# 3gtoRpTZKMZhthk75Ua8cPs/9Mj54XUAjL6Ctu+v2wsPnSNHZgDkSYpDdKfGcMF1
# c0DisjXKbpl77KV0ZhsPZwuQ1IC8sg9aOdWIBgA0MnrDPl14IZKUznAYP6uK5cFj
# iiW+awXWXB6xoedJW6KzbmqUrKfP0yUYxaGCAyAwggMcBgkqhkiG9w0BCQYxggMN
...
# MjYxOTUyMThaMC8GCSqGSIb3DQEJBDEiBCAuMSC8QUfp7Xla1W+xXGVOa0hVm9He
# 6Pr5zoP/FBGjXzANBgkqhkiG9w0BAQEFAASCAgADkpXTzUbuKmZr6XPoqHU3FE6S
# 73zt2j54EE8PLTQQ2B9p3LdiSOU1bFdu3C4DraRnrp3+NjtmS6F+X6LkIdsBXDVZ
# E45X2+J/TG84IKRt7uaPh3hLEpdoz18D0IuzQ+px7p6P3uI5J40udcbUGQP+viTN
# NrxCMDvd+SbqanTfMZ99xL2wqQzUg6K5qVC4+AzMBtqahbvCpJFxgRyJVMpDkcax
# jcxvghR6WNAAszp7BGABXYy3JcBVhJpOVwxWGHU4yna8u69KCePjGq3HD7+d7rAl
# cTUJB0PNoDB6J6Fy89tRX9OFgQMULeHwb6GaU51LKA2w5MGgoztQi/6FU9B9wIlS
# yZwQcVgQPz4OJf9LKmvcNM+5bXEQNS7PE4ZrlWoBvBro5gB5YUYTzkC4XaUykZkL
# v9dSKv6Fk06/g70jbxXpfaCFOKRo0tBQgyCTDlEMDi83l5PaV1dTCKKXICQty11o
# nQgQ0D4dn7yjwwoRrkzMKdCC8s5+sG/xeP+wqmjoHWml6asTyyybmNaJQ0Tukkg6
# IVX/3Pgk3GwrzK+qXrBUajlyMu2m1ovhkjRkGT/fiqk1PJ7FH7hmN8nSM9sLZxut
# DqtkqMKv4efzDMT6IWx5XsPEpbPKd9lG5/oICznU05WofLWXZJV0iWZim9AyiugK
# nHdWxyv69eV1t2PjZA==
