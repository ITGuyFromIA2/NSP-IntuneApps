...
$VariableConfig.DisplayName = "Dell Command | Update"
$VariableConfig.Description = "Downloads and installs the latest version of Dell Command | Update from Dell's website. Utilizes WGet from source or NetSys"
