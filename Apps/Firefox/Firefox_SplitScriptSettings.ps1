...
$VariableConfig.DisplayName = "Mozilla Firefox"
$VariableConfig.Description = ("Downloads and installs the latest version of {0} - Straight from Permalink" -f $VariableConfig.DisplayName)
