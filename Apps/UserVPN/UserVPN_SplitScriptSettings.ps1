...
$VariableConfig.VPNSettings.VPNAddress = "hnrconst.fortiddns.com"
$VariableConfig.VPNSettings.DNSSuffix = "hnrco.com" 
$VariableConfig.VPNSettings.UserTunnel = $true
$VariableConfig.VPNSettings.CAFilter = "CN=hnrco-CA" 
