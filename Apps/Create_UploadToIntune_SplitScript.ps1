...
#Get the current working DIR
    ...
    #Update-MSGraphEnvironment -AppId 090ece0f-135f-4f60-883e-3737dd5187a6
...
#Group names used for all Assignements
    $MasterSettings.Assign_DeviceGroup = "Group-MDM_Dynamic_AutoPilot_PCs";             #Assign to Device Group for auto-install
    $MasterSettings.Available_PeopleGroup = "Group-MDM_Dynamic_LicensedUsers";    #Assign to People Group for manual installs / reinstalls
...
$i = -1
$i++; $InterimCollection[$i]; set-clipboard $($InterimCollection[$i] | out-string)
